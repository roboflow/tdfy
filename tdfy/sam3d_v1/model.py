...
class TritonPythonModel:
    ...
    def checkpoint_path(self, module_name, ext):
        return os.path.join(self._current_folder, "checkpoints_configs", f"{module_name}.{ext}")

    def config_path(self, module_name):
        return os.path.join(self._current_folder, "checkpoints_configs", f"{module_name}.yaml")

    def load_kwargs(self):
        filepath = os.path.join(self._current_folder, "checkpoints_configs", "kwargs.json")
    ...
    def initialize(self, args):
        ...
        pipeline_config = OmegaConf.load(
            os.path.join(self._current_folder, "checkpoints_configs", f"pipeline.yaml")
        )
