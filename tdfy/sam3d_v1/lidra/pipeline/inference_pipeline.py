...
class InferencePipeline:
    ...
    def init_ss_generator(self, ss_generator_config_path, ss_generator_ckpt_path):
        ...
        if isinstance(self.ss_cfg_strength_pm, dict) or (
            ...
            config["reverse_fn"][
                "_target_"
            ] = "inference.models.sam3_3d.tdfy.sam3d_v1.lidra.model.backbone.generator.classifier_free_guidance.PointmapCFG"
        ...
        if layout_model_config_path is not None:
            ...
            if self.force_shape_in_layout:
                hydra_config["_target_"] = (
                    "inference.models.sam3_3d.tdfy.sam3d_v1.lidra.model.backbone.generator.flow_matching.model.ConditionalFlowMatching"
                )
