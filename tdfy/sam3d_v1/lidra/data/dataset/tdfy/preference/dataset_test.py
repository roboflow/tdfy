...
class TestPreferenceJobDataset(unittest.TestCase):
    ...
    @patch("inference.models.sam3_3d.tdfy.sam3d_v1.lidra.data.dataset.tdfy.preference.dataset.decode_mask")
    ...
    @patch("inference.models.sam3_3d.tdfy.sam3d_v1.lidra.data.dataset.tdfy.preference.dataset.load_rgb")
    @patch("os.path.exists")
