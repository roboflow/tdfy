...
class TestAnalysisComparisonProcessor(unittest.TestCase):
    ...
    @patch('inference.models.sam3_3d.tdfy.sam3d_v1.lidra.metrics.analysis.v3.processor.analysis_comparison.AnalysisComparisonProcessor._run_all_analyses')
    ...
    @patch('inference.models.sam3_3d.tdfy.sam3d_v1.lidra.metrics.analysis.v3.processor.analysis_comparison.ComparisonFormatter')
    ...
    @patch('inference.models.sam3_3d.tdfy.sam3d_v1.lidra.metrics.analysis.v3.processor.analysis_comparison.AnalysisComparisonProcessor._run_single_analysis')
    ...
    @patch('inference.models.sam3_3d.tdfy.sam3d_v1.lidra.metrics.analysis.v3.processor.multi_trial.MultiTrialProcessor')
